...
export const WHEEL_SECTORS: WheelSector[] = [
  { amount: 5, color: '#FF6B6B', promocode: 'avia100', probability: 0 },
  { amount: 10, color: '#4ECDC4', promocode: 'avia100', probability: 0 },
  { amount: 25, color: '#45B7D1', promocode: 'avia100', probability: 0 },
  { amount: 40, color: '#96CEB4', promocode: 'avia100', probability: 0 },
  { amount: 50, color: '#FFEAA7', promocode: 'avia100', probability: 0 },
  { amount: 100, color: '#DDA0DD', promocode: 'avia100', probability: 100 }
];
