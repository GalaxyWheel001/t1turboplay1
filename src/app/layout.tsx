...
export const metadata: Metadata = {
  metadataBase: new URL("https://bonus-turboplay.bet"),
  ...
  openGraph: {
    title: "TurboPlay — Casino Wheel of Fortune",
    description: "Try your luck! Spin the wheel of fortune and win prizes every day. No deposit, no risk!",
    url: "https://bonus-turboplay.bet",
    siteName: "TurboPlay",
    locale: "en_US",
    type: "website",
    images: [
      {
        url: "https://bonus-turboplay.bet/wheel-preview.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "TurboPlay — Casino Wheel of Fortune",
    description: "Try your luck! Spin the wheel of fortune and win prizes every day. No deposit, no risk!",
    images: ["https://bonus-turboplay.bet/wheel-preview.jpg"],
    creator: "@turboplay",
    site: "@turboplay",
  },
  alternates: {
    canonical: "https://bonus-turboplay.bet/",
  },
  other: {
    "theme-color": "#000000",
  ...
  return (
    <html lang={lang} className="antialiased">
      <head>
        ...
        <link rel="canonical" href="https://bonus-turboplay.bet/" />
